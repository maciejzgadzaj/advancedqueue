...
final class AdvancedQueueEvents {
  ...
  /**
   * The QUEUE_DELETE event is fired after suspending queue processing.
   *
   * @Event
   *
   * @var string
  ...
  /**
   * The ITEM_CREATE event is fired after creating a new queue item.
   *
   * @Event
   *
   * @var string
  ...
  /**
   * The ITEM_CLAIM event is fired after claiming a queue item for processing.
   *
   * @Event
   *
   * @var string
   */
  const ITEM_CLAIM = 'item.claim';
