...
class AdvancedQueueWorkerManager extends QueueWorkerManager {
  ...
  protected $defaults = [
    ...
    'dispatch_events' => [
      'queue' => [
        // A boolean indicating whether the "queue.delete" event should be
        // dispatched after deleting all items from a queue.
        'delete' => TRUE,
      ...
      'item' => [
        // A boolean indicating whether the "item.create" event should be
        // dispatched after creating a new queue item.
        'create' => TRUE,
        // A boolean indicating whether the "item.claim" event should be
        // dispatched after claiming a queue item for processing.
        'claim' => TRUE,
